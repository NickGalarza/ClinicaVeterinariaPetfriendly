document.getElementById("loginForm").addEventListener("submit", function(event) {
    ...
    const usuarioCorrecto = "veterinario";
    const claveCorrecta = "veterinario123";

    if (usuario === usuarioCorrecto && clave === claveCorrecta) {
        window.location.href = "veterinario.jsp"; // Redirige al usuario a la página de administración
    } else {
